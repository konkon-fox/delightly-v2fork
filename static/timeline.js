...
document.head.innerHTML +=
  '<link href="/static/st.css" rel="stylesheet" type="text/css"><link href="/static/milligram.css" rel="stylesheet" type="text/css"><link href="/static/s.css" rel="stylesheet" type="text/css"><link href="/static/read.css" rel="stylesheet" type="text/css"><link href="/static/lightbox.css" rel="stylesheet">';
document.body.innerHTML =
  '<section class="section"><div id="body"><div id="followheader" class="hidden maxwidth100 height2p5 stickymenu container" style="display: block;"><div class="row noflex maxwidth100 white padding0p5 maxheight2p5 borderbottomlightgrey"><div class="topmenu" id="header"><b class="menuitem">TL</b><a class="menuitem" href="/' +
  bbs +
  '/?m=subback">スレ一覧</a><a class="menuitem" href="/' +
  bbs +
  '/?m=subback&mode=history">履歴</a><a class="menuitem" href="/' +
  bbs +
  '/?m=subback&mode=unread">未読</a><a class="menuitem" href="/test/createthread.php?bbs=' +
  bbs +
  '">スレ作成</a><a class="menuitem" href="javascript:Menu()">メニュー</a><a href="javascript:MenuClick(\'setting\')" class="menuitem">設定</a><div id="headtitle" class="menuitem" style="text-decoration: none;"></div></div></div></div><div id="subbacktitle"></div><div class="formbox" style="margin-top: 3rem;"><form method="POST" id="Form" accept-charset="UTF-8" action="/test/post-v2.php" style="display: block;margin-top: 2rem;"> <span class="fhead" style="border-radius: 3px 3px 0 0;color: #666;padding: 3px;text-align: left;"><span class="spformhead" style="display:inline !important;border-radius:3px 3px 0 0;color:#666;padding:3px;"><a id="iconlink" target="_blank"><img id="icon" class="icon" width="50" height="50" align="left"></a><input name="name" placeholder="名前" class="formelem maxwidth" style="width:50%;margin-top:.5rem;"></span><span class="submitbtn" style="color: #000;float: right;font-size: 28px;font-weight: bold;cursor: pointer;display: inline-block;padding-right: 5px;"><input type="submit" value="新規投稿" name="submit" onclick="Post()"></span></span><input name="mail" size="19" value="" placeholder="E-mail" class="formelem maxwidth"><div class="backmsg" style="display: inline-block;"><input value="on" type="checkbox" id="seticon" name="icon" checked=""><a href="/test/icon.html">アイコン</a> <a href="javascript:BackMSG()">下書きを復元</a></div><textarea rows="5" cols="70" name="comment" id="bbs-textarea" onchange="MSG()" class="formelem maxwidth" wrap="off"></textarea><br>画像：<input id="uploadImage" type="file" name="file" size="50" onchange="upload();"><br><input type="hidden" name="board" value="' +
  bbs +
  '"></form></div><div class="tlnotice" id="ntxt"></div><div class="newposts"><center><a href="javascript:load()">リロード<img alt="再読み込み" loading="lazy" decoding="async" data-nimg="1" style="color: transparent;" src="/static/reload.svg" width="16" height="16"></a></center><hr></div><div id="thread" class="thread"></div><div id="hidemetoo" class="side p85 slightpad nobullets"><div style="min-height:50px" id="rule">■ ローカルルール<br></div><div style="min-height:50px" id="kokuti">■ 告知欄<br></div><p style="margin: 5rem 0"></p></div><div class="footer"><a href="https://git.3chan.cc/stat2/delightly-v2fork">スレッドフロート型掲示板「delightly」v2 fork</a>, <a href="https://delightly.xyz/">nore</a> +</div></div></section>';
...
document.getElementById('body').innerHTML +=
  '<style>.subject {background: gray;color: #fff;}div.postbutton{display: none !important;}</style>';
...
function load() {
  ...
  request.onload = function () {
    ...
    listJSON.forEach(function (post) {
      ...
      if (isSmartPhone() == false)
        newpost.innerHTML =
          '<a class="number" href="javascript:reply(\'' +
          mail +
          '\')">' +
          n +
          '</a><span class="name"><b>' +
        ...
        newpost.innerHTML =
          ...
          '</span><div class="message">' +
          comment +
          '</div><span class="date"><a class="id" href="javascript:IdClick(\'' +
          id +
          '\')">' +
          id +
          '</a>' +
...
function Menu() {
  document.getElementById('modal_text').innerHTML =
    '<a class="menulink" href="/test/TL.html">タイムライン絞り込み設定</a><div style="font-weight:bold;">ミュート設定</div><a class="menulink" href="javascript:mute(\'list\')">ID</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngword\')">Word</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngtitle\')">タイトル</a><div style="font-weight:bold;">その他</div><a class="menulink" href="javascript:MenuClick(\'setting\')">閲覧設定</a>&emsp;<a class="menulink" href="/test/backimg.html">背景画像</a>&emsp;<a class="menulink" href="/test/css.html">カスタムcss</a><br><a class="menulink" href="javascript:setclear()">全ログを削除</a>&emsp;<a class="menulink" href="/test/auth.php">認証</a>';
  document.getElementById('rModal').style.display = 'block';
}
