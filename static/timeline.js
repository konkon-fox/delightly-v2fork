...
document.body.innerHTML =
  ...
  bbs +
  '"></form></div><div class="tlnotice" id="ntxt"></div><div class="newposts"><center><a href="javascript:load()">リロード<img alt="再読み込み" loading="lazy" decoding="async" data-nimg="1" style="color: transparent;" src="/static/reload.svg" width="16" height="16"></a></center><hr></div><div id="thread" class="thread"></div><div id="hidemetoo" class="side p85 slightpad nobullets"><div style="min-height:50px" id="rule">■ ローカルルール<br></div><div style="min-height:50px" id="kokuti">■ 告知欄<br></div><p style="margin: 5rem 0"></p></div><div class="footer"><a href="https://github.com/konkon-fox/delightly-v2fork">スレッドフロート型掲示板「delightly-v2fork」</a>, nore +</div></div></section>';
